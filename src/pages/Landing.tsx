  ...
  return (
    <div className="min-h-screen bg-[#3d3d3d] flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-[680px] bg-white rounded-2xl shadow-2xl relative">
        ...
        <button
          onClick={() => {}}
          className="absolute top-4 right-5 text-[#515151] hover:text-black transition-colors z-10"
          aria-label="닫기"
        >
        ...
        <div className="px-10 py-10 flex flex-col items-center">
          ...
          {/* 케비쌤 서비스 버튼 */}
          <button className="bg-[#026eff] text-white px-9 py-2.5 rounded-full mb-7 cursor-default">
