  ...
  return (
    <div className="p-4 sm:p-7 space-y-5 sm:space-y-6">
      <div>
        ...
        <p className="text-xs text-gray-500 mt-0.5">아이의 돌봄을 함께하는 전문가 팀</p>
      </div>

      {careTeam.length === 0 ? (
        <div className="bg-white rounded-2xl border border-gray-100 p-8 text-center">
          <i className="ri-team-line text-3xl text-gray-200 mb-2" />
          <p className="text-sm text-gray-500">아직 배정된 돌봄 팀원이 없습니다</p>
        </div>
      ) : (
            ...
            return (
              <div key={member.id} className="bg-white rounded-2xl border border-gray-100 p-4 sm:p-5 flex items-start gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[12.5px] text-gray-500 mb-3 truncate">돌봄 팀 소속</p>
                </div>
              </div>
            );
          })}
