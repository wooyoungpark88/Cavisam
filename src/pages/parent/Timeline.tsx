...
export function ParentTimeline() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-5">
      {/* ── Header ── */}
      <div className="bg-white rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.02)] border border-gray-200/60 p-6">
      ...
      <button
        ...
        className="w-full bg-white rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.02)] border border-gray-200/60 p-4 hover:shadow-[0_4px_12px_rgba(0,0,0,0.06)] hover:border-purple-200 transition-all duration-300 flex items-center gap-4"
      >
          ...
          <div className="bg-white rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.02)] border border-gray-200/60 p-6">
            ...
            <div className="space-y-3">
              {TIMELINE_DATA.map((entry) => (
                <div
                  key={entry.id}
                  className={`bg-white rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.02)] border border-gray-200/60 p-4 hover:shadow-[0_2px_8px_rgba(0,0,0,0.06)] transition-shadow duration-300 ${cardBorderClass(entry.type)}`}
                >
                  {/* Card Header */}
