    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-1.5 mb-0.5">
          ...
          {member.isMe && <span className="text-[11px] text-[#026eff] font-semibold whitespace-nowrap">나</span>}
        </div>
        <span
      ...
      <div className="flex-shrink-0 text-right">
        <p className="text-[12.5px] font-bold text-gray-700">{member.assignedStudentIds.length}</p>
        <p className="text-[11px] text-gray-400">담당</p>
      </div>
    </button>
  );
}
  ...
  return (
    <div className="p-5 space-y-3">
      <div className="flex items-center justify-between mb-1">
        ...
        <p className="text-[12.5px] text-gray-400">총 {studentAssignments.length}명</p>
      </div>
            ...
            >
              <div className="flex items-center gap-3 mb-2.5">
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-2 py-1 rounded-lg text-[12px] font-semibold cursor-pointer whitespace-nowrap transition-all hover:bg-gray-100"
                  style={{ color: "#6b7280" }}
                >
              ...
              <div className="flex flex-wrap gap-1.5">
                {sa.assignedMemberIds.map((mid) => {
                  ...
                  return (
                    <div
                      key={String(mid)}
                      className="flex items-center gap-1 px-2 py-0.5 rounded-full text-[12px] font-semibold transition-all"
                      style={{
                ...
                {sa.assignedMemberIds.length === 0 && (
                  <span className="text-[12px] text-gray-400 italic">담당 팀원이 없습니다</span>
                )}
              </div>
            </div>
          );
          ...
          {upcoming.map((mtg) => {
            ...
            return (
              <div key={mtg.id} className="bg-white rounded-xl border border-gray-100 p-4">
                ...
                <div className="flex flex-wrap gap-3 mb-3 text-[12.5px] text-gray-500">
                ...
                <div className="space-y-1 mb-3">
                  <p className="text-[12px] font-bold text-gray-400 uppercase tracking-wide mb-1.5">안건</p>
                  {mtg.agenda.map((a, i) => (
                    <div key={i} className="flex items-start gap-2">
                      <span className="w-4 h-4 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <span className="w-1 h-1 rounded-full bg-gray-300" />
                      </span>
                      <p className="text-[12.5px] text-gray-600 leading-relaxed">{a}</p>
                    </div>
                  ))}
                </div>
                <div className="flex items-center gap-1.5 pt-2 border-t border-gray-100">
                  <p className="text-[12px] text-gray-400 mr-1">참석</p>
                  ...
                  <span className="text-[12px] text-gray-400 ml-1">{mtg.participants.length}명</span>
                </div>
              </div>
            );
          })}
          ...
          {past.map((mtg) => {
            ...
            return (
              <div key={mtg.id} className="bg-white rounded-xl border border-gray-100 p-4 opacity-80">
                ...
                <div className="flex flex-wrap gap-3 text-[12.5px] text-gray-400 mb-2">
                  <span className="flex items-center gap-1">
                ...
                {mtg.notes && (
                  <div className="mt-2 px-3 py-2 rounded-lg bg-gray-50 border border-gray-100">
                    <p className="text-[12.5px] text-gray-500 leading-relaxed">{mtg.notes}</p>
                  </div>
                )}
              </div>
            );
          ...
          {activities.map((act) => {
            ...
            return (
              <div key={act.id} className="relative pl-10">
                ...
                >
                  <i className={`${ai.icon} text-[12px]`} style={{ color: ai.color }} />
                </div>
                <div className="bg-white rounded-xl border border-gray-100 p-3">
                  <div className="flex items-center gap-2 mb-1.5">
                    ...
                    <span className="text-gray-400 text-[12px] ml-auto whitespace-nowrap">{act.time}</span>
                  </div>
                  <p className="text-gray-800 text-[12.5px] font-semibold mb-0.5">{act.action}</p>
                  <p className="text-gray-500 text-[12.5px] leading-relaxed">{act.target}</p>
                </div>
              </div>
            );
          })}
  ...
  return (
    <div className="flex h-full overflow-hidden">
      ...
      <aside className="hidden md:flex flex-col border-r border-gray-100 bg-white overflow-hidden flex-shrink-0" style={{ width: 256 }}>
        ...
        <div className="flex-shrink-0 px-4 pt-5 pb-3 border-b border-gray-100">
          <div className="flex items-center justify-between mb-1">
            ...
            <div className="flex items-center gap-2">
              <span className="text-[12.5px] text-gray-400">{teamMembers.length}명</span>
              <button
                onClick={() => setShowAddMember(true)}
                className="flex items-center gap-1 px-2 py-1 rounded-lg text-[12px] font-semibold cursor-pointer whitespace-nowrap transition-all"
          ...
          <p className="text-gray-400 text-[12.5px]">돌봄 팀 현황</p>
        </div>
            ...
            {["전체", "교사", "치료사", "복지사", "전문가"].map((label) => {
              ...
              return (
                <button
                  ...
                  className="px-2.5 py-0.5 rounded-full text-[12px] font-semibold cursor-pointer whitespace-nowrap transition-all"
                  style={{
        ...
        {addedSuccess && (
          <div className="flex-shrink-0 mx-3 mt-2 px-3 py-2 rounded-lg text-[12.5px] font-semibold text-[#059669] flex items-center gap-2" style={{ background: "#f0fdf4", border: "1px solid #bbf7d0" }}>
        ...
        {selectedMember && (
          <div className="flex-shrink-0 border-t border-gray-100 px-4 py-4 space-y-2.5">
            <p className="text-[12px] font-bold text-gray-400 uppercase tracking-wide">선택된 팀원 정보</p>
            <div className="space-y-1.5">
              <div className="flex items-start gap-2">
                <div className="w-3.5 h-3.5 flex items-center justify-center flex-shrink-0 mt-0.5"><i className="ri-phone-line text-[12px] text-gray-400" /></div>
                <p className="text-[12.5px] text-gray-500">{selectedMember.phone}</p>
              </div>
              <div className="flex items-start gap-2">
                <div className="w-3.5 h-3.5 flex items-center justify-center flex-shrink-0 mt-0.5"><i className="ri-mail-line text-[12px] text-gray-400" /></div>
                <p className="text-[12.5px] text-gray-500 break-all">{selectedMember.email}</p>
              </div>
              <div className="flex items-start gap-2">
                <div className="w-3.5 h-3.5 flex items-center justify-center flex-shrink-0 mt-0.5"><i className="ri-time-line text-[12px] text-gray-400" /></div>
                <p className="text-[12.5px] text-gray-500">{selectedMember.availableTime}</p>
              </div>
              <div className="flex items-start gap-2">
                <div className="w-3.5 h-3.5 flex items-center justify-center flex-shrink-0 mt-0.5"><i className="ri-star-line text-[12px] text-gray-400" /></div>
                <p className="text-[12.5px] text-gray-500 leading-relaxed">{selectedMember.specialty}</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="md:hidden flex-shrink-0 border-b border-gray-100 bg-white">
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-gray-50">
            <div>
              ...
              <p className="text-[12px] text-gray-400">돌봄 팀 현황</p>
            </div>
            <button
              onClick={() => setShowAddMember(true)}
              className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-[12.5px] font-semibold cursor-pointer whitespace-nowrap"
              style={{ background: "#eff6ff", color: "#026eff" }}
            >
              <i className="ri-user-add-line text-xs" />
              팀원 추가
          ...
          <div className="flex items-center gap-2 px-4 py-3 overflow-x-auto">
            ...
            >
              ...
              <span className="text-[11px] text-gray-500 whitespace-nowrap">전체</span>
            </button>
            {teamMembers.map((m) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-[11px] text-gray-500 whitespace-nowrap max-w-[44px] truncate">{m.name}</span>
                </button>
              );
            })}
          </div>
          ...
          {selectedMember && (
            <div className="px-4 pb-3 flex items-center gap-3 overflow-x-auto">
              <div className="flex items-center gap-1.5 flex-shrink-0">
                <i className="ri-phone-line text-[12px] text-gray-400" />
                <span className="text-[12.5px] text-gray-500 whitespace-nowrap">{selectedMember.phone}</span>
              </div>
              <span className="text-gray-200 text-xs">|</span>
              <div className="flex items-center gap-1.5 flex-shrink-0">
                <i className="ri-time-line text-[12px] text-gray-400" />
                <span className="text-[12.5px] text-gray-500 whitespace-nowrap">{selectedMember.availableTime}</span>
              </div>
              <span className="text-gray-200 text-xs">|</span>
              <span
                className="text-[12px] font-semibold px-2 py-0.5 rounded-full whitespace-nowrap flex-shrink-0"
            ...
            {selectedMember ? (
              <>
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-[12px]">담당 이용인 {selectedMember.assignedStudentIds.length}명 · {selectedMember.department}</p>
                </div>
                <button onClick={() => setSelectedMemberId(null)} className="ml-2 text-[12px] text-gray-400 hover:text-gray-600 cursor-pointer whitespace-nowrap">
