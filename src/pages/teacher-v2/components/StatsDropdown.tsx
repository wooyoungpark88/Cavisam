...
export default function StatsDropdown({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div
      className="absolute right-0 top-10 bg-white rounded-2xl z-50 border border-gray-100 overflow-hidden"
      style={{ width: 300, boxShadow: "0 8px 32px rgba(0,0,0,0.10)" }}
    >
      {/* Tabs */}
